...
class SparkReview(BaseModel):
    """
    Review from a single Spark (Brain, Gut, Eyes, Soul).

    NOTE: Real Spark integration happens in Phase 2.
    For now, these are generated by stub logic.
    """
    spark: Literal["Brain", "Gut", "Eyes", "Soul"]
