...
def _initialize_core_sparks():
    """Initialize and register the 4 core Sparks."""
    brain = BrainSpark()
    gut = GutSpark()
    eyes = EyesSpark()
    soul = SoulSpark()
    ...
    logger.info("Core Sparks initialized: Brain, Gut, Eyes, Soul")


# Initialize on import
_initialize_core_sparks()

__all__ = ["registry", "BrainSpark", "GutSpark", "EyesSpark", "SoulSpark"]
